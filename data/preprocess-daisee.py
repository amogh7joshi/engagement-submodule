    ...
    for dataset in list(os.walk(datadir))[0][1]:
        ...
        for user in users:
            ...
            for video in videos:
                ...
                clip = os.listdir(os.path.join(datadir, dataset, user, video))
                try:
...
# Should only be used for intermediate cleaning or if absolutely necessary, a complete image removal function.
def remove_files():
